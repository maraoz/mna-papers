...
\warn poner que error se tomo para el calculo $(10^-5)$.
\begin{figure*}
  \begin{center}
      \epsfig{file=images/concentracionneutrones.pdf, width=400px}
       \caption[Gráfico de la concentración de neutrones]{Concentración de neutrones en estado estacionario en función de la distancia.}
