...
% 2. The aastex class file includes some useful astronomy definitions,
% for example special math symbols that are commonly used.  Use
% emulateapj instead to make Apj format.
% YOU SHOULD REMOVE THE TABLE OF
% CONTENTS PAGE WHEN USING APJ FORMAT.
%
%\documentclass[11pt,a4paper]{aastex}
